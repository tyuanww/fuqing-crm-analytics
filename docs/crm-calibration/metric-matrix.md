...
当前工作树为 `codex/dsh-017-rc1`，VERSION `0.18.0.0`，公开 main 基线 `bcc0ced9`；下方指标证据保留 2026-09-21 的 v0.14.0.0 历史验收口径。不重做已上线 AOV/AUS 公式。真实归档只读元数据探针（DuckDB 1.5.3，512MB，未改写 131GB 文件）见本文件来源列。金额不入库。
