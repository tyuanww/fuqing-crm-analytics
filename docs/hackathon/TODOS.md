...
### 2026-09-21 当前三步（CRM 分析持久化）

基于新公开仓库 main `106717e6`，分支 `codex/crm-assets-release`；[本轮交付记录](../crm-calibration/crm-assets-release-2026-09-21.md)。原工作树成果保留。
...
- [ ] 新公开主线候选完整门禁、浏览器 QA、提交/推送/PR/CI 与合并。
- [ ] 保留历史与依赖环境的现役切换、真实登录保存/引用/重开、回退回执。
- [ ] CRM 完整历史检索、编辑/共享和可编辑组板合同；多人文档 ACL。
- [ ] 图谱全图语义审核与原文同版本；会员/退款/复购/LTV/派样来源。
