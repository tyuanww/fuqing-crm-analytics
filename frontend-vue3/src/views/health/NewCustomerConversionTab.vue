...
const channelColumns: DataTableColumns<any> = [
  ...
  { title: '30日复购率', key: 'day30_repurchase_rate', align: 'right',
    render: (row) => formatPercent(row.day30_repurchase_rate),
  },
  { title: '90日复购率', key: 'day90_repurchase_rate', align: 'right',
    render: (row) => formatPercent(row.day90_repurchase_rate),
  },
      ...
      <div v-if="data.monthly_trend?.length" class="bi-card p-4 mb-4">
        ...
        <NDataTable
          :columns="[
            ...
            { title: '7日复购率', key: 'day7_rate', align: 'right', render: (row: any) => formatPercent(row.day7_rate) },
            { title: '30日复购率', key: 'day30_rate', align: 'right', render: (row: any) => formatPercent(row.day30_rate) },
            { title: '90日复购率', key: 'day90_rate', align: 'right', render: (row: any) => formatPercent(row.day90_rate) },
          ]"
